...
export const metadata: Metadata = {
  title: 'Industrial Equipment Restoration & Decontamination | MD, DC, VA',
  description: 'Industrial equipment restoration serving MD, DC, VA. Machinery decontamination, production line recovery, minimal downtime. Specialized commercial restoration.',
  keywords: [
    'industrial equipment restoration',
    'machinery decontamination',
    'manufacturing facility restoration',
    'production line recovery',
    'industrial cleaning Maryland',
    'DC industrial restoration',
    'Virginia equipment restoration',
  ],
  openGraph: {
    title: 'Industrial Equipment Restoration & Decontamination',
    description: 'Industrial equipment restoration serving MD, DC, VA. Machinery decontamination, production line recovery, minimal downtime.',
    type: 'website',
  },
}

export default function IndustrialEquipmentPage() {
  const serviceData = getServiceData('industrial-equipment')
  const relatedServices = getRelatedServicesData('industrial-equipment')
