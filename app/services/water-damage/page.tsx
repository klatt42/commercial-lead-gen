...
export const metadata: Metadata = {
  title: 'Commercial Water Damage Restoration | 24/7 Emergency MD, DC, VA',
  description: 'Emergency commercial water damage restoration serving MD, DC, VA. Industrial water extraction, structural drying, moisture detection. <60min response. Licensed & insured.',
  keywords: [
  ...
  openGraph: {
    title: 'Commercial Water Damage Restoration | 24/7 Emergency MD, DC, VA',
    description: 'Emergency commercial water damage restoration serving MD, DC, VA. Industrial water extraction, structural drying, moisture detection. <60min response.',
    url: 'https://commercial-lead-gen.vercel.app/services/water-damage',
  },
}

export default function WaterDamagePage() {
  const serviceData = getServiceData('water-damage')

  if (!serviceData) {
    return <div>Service not found</div>
  }

  const relatedServices = getRelatedServicesData('water-damage')
