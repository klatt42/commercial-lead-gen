...
export const metadata: Metadata = {
  title: 'Commercial Mold Remediation & Removal | EPA-Certified MD, DC, VA',
  description: 'EPA-certified commercial mold remediation serving MD, DC, VA. Safe mold removal, air quality testing, IICRC protocols. Protect employees and comply with regulations. Licensed & insured.',
  keywords: [
  ...
  openGraph: {
    title: 'Commercial Mold Remediation & Removal | EPA-Certified MD, DC, VA',
    description: 'EPA-certified commercial mold remediation serving MD, DC, VA. Safe mold removal, air quality testing, IICRC protocols. Protect employees and comply with regulations.',
    url: 'https://commercial-lead-gen.vercel.app/services/mold-remediation',
  },
}

export default function MoldRemediationPage() {
  const serviceData = getServiceData('mold-remediation')

  if (!serviceData) {
    return <div>Service not found</div>
  }

  const relatedServices = getRelatedServicesData('mold-remediation')
